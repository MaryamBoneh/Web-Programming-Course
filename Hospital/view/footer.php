        <footer class="page-footer">
            <div class="container">
                <div class="row px-md-3">
                    ...
                    <h5>Contact</h5>
                    <p class="footer-link mt-2">Mashhad, Seyyedrazi</p>
                    <br>
                    <a href="#" class="footer-link">098-51311112222</a>
                    <br>
            ...
            <p id="copyright">Copyright &copy; 2022 <a href="https://macodeid.com/" target="_blank">Maryam</a>. All right reserved</p>
            </div>
        </footer>

        <script src="view/js/jquery-3.5.1.min.js"></script>
        <script src="view/js/bootstrap.bundle.min.js"></script>
        <script src="view/vendor/owl-carousel/js/owl.carousel.min.js"></script>
